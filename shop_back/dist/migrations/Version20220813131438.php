 ...
 */
final class Version20220813131438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vendor (id INT NOT NULL, code VARCHAR(128) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
